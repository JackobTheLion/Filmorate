...
public class UserControllerTest {
    ...
    public void addFriendNormal() {
        ...
        assertEquals(user1ExpectedFriends, user1.getConfirmedFriends());
        assertEquals(user2ExpectedFriends, user2.getConfirmedFriends());
    }
    ...
    public void deleteFriendNormal() {
        ...
        assertTrue(user1.getConfirmedFriends().isEmpty());
        assertTrue(user2.getConfirmedFriends().isEmpty());
    }
